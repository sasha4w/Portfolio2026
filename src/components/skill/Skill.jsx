...
// --- DONNÉES (SVG + tags non traduisibles restent ici) ---
...
const SKILLS_DATA = [
  ...
  },
  {
    icon: (
      <svg
        ...
        fill="currentColor"
      >
        <path d="M3 3v18h18V3H3zm16 16H5V5h14v14zM11 7h6v2h-6V7zm0 4h6v2h-6v-2zm0 4h6v2h-6v-2zM7 7h2v10H7V7z" />
      </svg>
    ),
    titleKey: "cms",
    tags: [
  ...
  },
  {
    ...
    titleKey: "languages",
    // tags injectés dynamiquement depuis t
    tags: "langTags",
  },
  {
    icon: (
...
export function Skill() {
  ...
  // Tags traduits injectés dynamiquement
  const translatedTags = {
    langTags: t.skill.langTags.map((name, i) => ({ name, highlight: i < 3 })),
    softTags: t.skill.softTags.map((name) => ({ name })),
  };
  ...
  const resolveSkill = (skill) => ({
    ...skill,
    title: t.skill.titles[skill.titleKey],
    tags:
      typeof skill.tags === "string" ? translatedTags[skill.tags] : skill.tags,
  });

  const count = SKILLS_DATA.length;
  const skill = resolveSkill(SKILLS_DATA[selected]);

  return (
    <section id="skills">
      <div class="container">
        <div class="sectionLabel">{t.skill.sectionLabel}</div>
        <h2 class="sectionTitle">
          {t.skill.sectionTitle} <span>{t.skill.sectionTitleSpan}</span>
        </h2>
            ...
            <div class={styles.wheel}>
              ...
              {SKILLS_DATA.map((s, i) => (
                <button
                  ...
                  class={
                    selected === i
                      ? styles.wheelBtn + " " + styles.wheelBtnActive
                      : styles.wheelBtn
                  }
                  style={`--i: ${i}`}
                  onClick={() => setSelected(i)}
                  title={t.skill.titles[s.titleKey]}
                  aria-label={t.skill.titles[s.titleKey]}
                >
              ...
              <div class={styles.tags}>
                {skill.tags.map((tag, i) => (
                  <span
                    key={i}
                    class={
                      tag.highlight ? styles.tag + " " + styles.hi : styles.tag
                    }
        ...
        <h3 class="formationTitle">{t.skill.formationTitle}</h3>
